...
import org.tdcoin.protocols.payments.Protos.PaymentDetails;
...
import org.tdcoinj.wallet.Wallet.MissingSigsMode;
...
public class SendRequest {
     ...
     * is how mining is incentivized in later years of the Tdcoin system when inflation drops. It also provides
     ...
     * when choosing which transactions to add to a block. Note that, to keep this equivalent to Tdcoin Core
    ...
    /**
     * <p>Requires that there be enough fee for a default Tdcoin Core to at least relay the transaction.
