...
public class BasicKeyChain implements EncryptableKeyChain {
     ...
     * @throws org.tdcoinj.wallet.UnreadableWalletException.BadPassword if the password doesn't seem to match
     * @throws org.tdcoinj.wallet.UnreadableWalletException if the data structures are corrupted/inconsistent
     */
    ...
    public BasicKeyChain toEncrypted(KeyCrypter keyCrypter, KeyParameter aesKey) {
        ...
        try {
            ...
            for (ECKey key : hashToKeys.values()) {
                ...
                // (all tdcoin controlled by that private key is lost forever).
