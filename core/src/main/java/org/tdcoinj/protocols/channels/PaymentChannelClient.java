...
import org.tdcoinj.protocols.channels.PaymentChannelCloseException.CloseReason;
...
public class PaymentChannelClient implements IPaymentChannelClient {
        ...
        switch (majorVersion) {
            case 1:
                ...
                Protos.ProvideRefund.Builder provideRefundBuilder = Protos.ProvideRefund.newBuilder()
                        ...
                        .setTx(ByteString.copyFrom(((PaymentChannelV1ClientState)state).getIncompleteRefundTransaction().unsafeTdcoinSerialize()));
            ...
            case 2:
                ...
                Protos.ProvideContract.Builder provideContractBuilder = Protos.ProvideContract.newBuilder()
                        .setTx(ByteString.copyFrom(state.getContract().unsafeTdcoinSerialize()))
                ...
                try {
                    ...
                    initialMsg.setSignature(ByteString.copyFrom(payment.signature.encodeToTdcoin()));
     ...
     * be accepted by the Tdcoin network. ValueOutOfRangeException will be thrown, however, if there's not enough money
    ...
    public ListenableFuture<PaymentIncrementAck> incrementPayment(Coin size, @Nullable ByteString info, @Nullable KeyParameter userKey)
        ...
        try {
            ...
            Protos.UpdatePayment.Builder updatePaymentBuilder = Protos.UpdatePayment.newBuilder()
                    .setSignature(ByteString.copyFrom(payment.signature.encodeToTdcoin()))
