...
import org.tdcoinj.protocols.channels.IPaymentChannelClient.ClientChannelProperties;
import org.tdcoinj.script.Script;
import org.tdcoinj.script.ScriptBuilder;
import org.tdcoinj.script.ScriptException;
import org.tdcoinj.wallet.AllowUnconfirmedCoinSelector;
...
public class PaymentChannelV1ClientState extends PaymentChannelClientState {
    ...
    public synchronized void initiate(@Nullable KeyParameter userKey, ClientChannelProperties clientChannelProperties) throws ValueOutOfRangeException, InsufficientMoneyException {
        ...
        // relies on the fact that since Tdcoin 0.8 time locked transactions are non-final. This will need to change
    ...
    public synchronized void provideRefundSignature(byte[] theirSignature, @Nullable KeyParameter userKey)
        ...
        TransactionSignature theirSig = TransactionSignature.decodeFromTdcoin(theirSignature, true, false);
