...
package org.tdcoinj.protocols.payments;
 ...
 *
 * <ul>
 * <li>A {@link TdcoinURI} object that conforms to BIP 0072</li>
 * <li>A url where the {@link Protos.PaymentRequest} can be fetched</li>
 * <li>Directly with a {@link Protos.PaymentRequest} object</li>
 * </ul>
 *
 * <p>If initialized with a TdcoinURI or a url, a network request is made for the payment request object and a
 ...
 * transactions to the tdcoin network. Instead it returns a ListenableFuture that will be notified when a
 ...
 *
 * @see <a href="https://github.com/tdcoin/bips/blob/master/bip-0070.mediawiki">BIP 0070</a>
 */
public class PaymentSession {
     ...
     * uri is a BIP-72-style TdcoinURI object that specifies where the {@link Protos.PaymentRequest} object may
     ...
     * be verified.</p>
     */
    public static ListenableFuture<PaymentSession> createFromTdcoinUri(final TdcoinURI uri) throws PaymentProtocolException {
        return createFromTdcoinUri(uri, true, null);
    }
     ...
     */
    public static ListenableFuture<PaymentSession> createFromTdcoinUri(final TdcoinURI uri, final boolean verifyPki)
            throws PaymentProtocolException {
        return createFromTdcoinUri(uri, verifyPki, null);
    }
     ...
     */
    public static ListenableFuture<PaymentSession> createFromTdcoinUri(final TdcoinURI uri, final boolean verifyPki, @Nullable final TrustStoreLoader trustStoreLoader)
            throws PaymentProtocolException {
        String url = uri.getPaymentRequestUrl();
        if (url == null)
            throw new PaymentProtocolException.InvalidPaymentRequestURL("No payment request URL (r= parameter) in TdcoinURI " + uri);
        try {
    ...
    /**
     * Returns the total amount of tdcoins requested.
     */
     ...
     * NOTE: This does not broadcast the transactions to the tdcoin network, it merely sends a Payment message to the
