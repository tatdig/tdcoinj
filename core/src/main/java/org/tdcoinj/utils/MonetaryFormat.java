...
public final class MonetaryFormat {
    ...
    /** Standard format for the TDC denomination. */
    public static final MonetaryFormat TDC = new MonetaryFormat().shift(0).minDecimals(2).repeatOptionalDecimals(2, 3);
    /** Standard format for the mTDC denomination. */
    public static final MonetaryFormat MTDC = new MonetaryFormat().shift(3).minDecimals(2).optionalDecimals(2);
    /** Standard format for the µTDC denomination. */
    public static final MonetaryFormat UTDC = new MonetaryFormat().shift(6).minDecimals(0).optionalDecimals(2);
    /** Standard format for fiat amounts. */
    public static final MonetaryFormat FIAT = new MonetaryFormat().shift(0).minDecimals(2).repeatOptionalDecimals(2, 1);
    /** Currency code for base 1 Tdcoin. */
    public static final String CODE_TDC = "TDC";
    /** Currency code for base 1/1000 Tdcoin. */
    public static final String CODE_MTDC = "mTDC";
    /** Currency code for base 1/1000000 Tdcoin. */
    public static final String CODE_UTDC = "µTDC";
    /** Currency symbol for base 1 Tdcoin. */
    public static final String SYMBOL_TDC = "\u0054";
    /** Currency symbol for base 1/1000 Tdcoin. */
    public static final String SYMBOL_MTDC = "m" + SYMBOL_TDC;
    /** Currency symbol for base 1/1000000 Tdcoin. */
    public static final String SYMBOL_UTDC = "µ" + SYMBOL_TDC;
    ...
    private static final String DECIMALS_PADDING = "0000000000000000"; // a few more than necessary for Tdcoin
    ...
    /**
     * Set number of digits to shift the decimal separator to the right, coming from the standard TDC notation that was
    ...
    public MonetaryFormat(boolean useTdcoinSymbol) {
        // defaults
        this.negativeSign = '-';
        ...
        this.codes[0] = useTdcoinSymbol ? SYMBOL_TDC : CODE_TDC;
        this.codes[3] = useTdcoinSymbol ? SYMBOL_MTDC : CODE_MTDC;
        this.codes[6] = useTdcoinSymbol ? SYMBOL_UTDC : CODE_UTDC;
        this.codeSeparator = ' ';
