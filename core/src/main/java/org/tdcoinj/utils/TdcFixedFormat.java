...
import static org.tdcoinj.core.Coin.SMALLEST_UNIT_EXPONENT;
...
/**
 * <p>This class, a concrete extension of {@link TdcFormat}, is distinguished in that each
 * instance formats and by-default parses all Tdcoin monetary values in units of a single
 ...
 * custom pattern using either the {@link TdcFormat.Builder#localizedPattern} or
 * {@link TdcFormat.Builder#localizedPattern} methods, as described in the documentation for
 * the {@link TdcFormat.Builder} class.</p>
 *
 * <p>A more detailed explanation, including examples, is in the documentation for the
 * {@link TdcFormat} class, and further information beyond that is in the documentation for the
...
public final class TdcFixedFormat extends TdcFormat {
     ...
     *  the same value expressed in tdcoins. */
    private final int scale;

    /** Constructor */
    protected TdcFixedFormat(
     ...
     * the denomination is millitdcoins, this method will return the value {@code 3}.  As
     ...
     *  the denomination is millitdcoins, this method will return the value {@code 3}.  */
    @Override
     ...
     * denomination is millitdcoins, then this method will return {@code "mTDC"},
     * assuming the default base currency-code is not overridden using a
     * {@link TdcFormat.Builder}.  */
     ...
     * millitdcoins, this method by default returns {@code "₥฿"}, depending on the
     * locale.  */
    ...
    @Override public boolean equals(Object o) {
        ...
        if (!(o instanceof TdcFixedFormat)) return false;
        TdcFixedFormat other = (TdcFixedFormat)o;
