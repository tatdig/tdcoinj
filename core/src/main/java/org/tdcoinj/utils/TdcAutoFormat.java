...
/**
 * <p>This class, a concrete extension of {@link TdcFormat}, is distinguished by its
 * accommodation of multiple denominational units as follows:
 *
 * <p>When formatting Tdcoin monetary values, an instance of this class automatically adjusts
 ...
 *
 * <p>When parsing {@code String} representations of Tdcoin monetary values, instances of
 ...
 * TdcFormat} class, and further information beyond that is in the documentation for the {@link
 ...
 * @see          org.tdcoinj.core.Coin
 */

public final class TdcAutoFormat extends TdcFormat {
    ...
    public enum Style {
        ...
        /** Constant for the formatting style that uses a currency code, e.g., "TDC". */
        CODE {
    ...
    /** Constructor */
    protected TdcAutoFormat(Locale locale, Style style, int fractionPlaces) {
    ...
    /**
     * Calculate the appropriate denomination for the given Tdcoin monetary value.  This
    ...
    @Override public boolean equals(Object o) {
        ...
        if (!(o instanceof TdcAutoFormat)) return false;
