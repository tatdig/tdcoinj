...
public abstract class MessageSerializer {
     ...
     */
    public abstract TdcoinSerializer.TdcoinPacketHeader deserializeHeader(ByteBuffer in) throws ProtocolException, IOException, UnsupportedOperationException;

    /**
     * Deserialize payload only.  You must provide a header, typically obtained by calling
     * {@link TdcoinSerializer#deserializeHeader}.
     */
    public abstract Message deserializePayload(TdcoinSerializer.TdcoinPacketHeader header, ByteBuffer in) throws ProtocolException, BufferUnderflowException, UnsupportedOperationException;
