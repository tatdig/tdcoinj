 ...
 * Currently this includes getaddr, verack and special tdcoinj class UnknownMessage.</p>
 * 
...
public abstract class EmptyMessage extends Message {
    ...
    @Override
    protected final void tdcoinSerializeToStream(OutputStream stream) throws IOException {
    }
