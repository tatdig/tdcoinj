...
import static org.tdcoinj.core.Sha256Hash.*;

/**
 * <p>A block is a group of transactions, and is one of the fundamental data structures of the Tdcoin system.
 ...
 * <a href="http://www.tdcoin.org/tdcoin.pdf">the Tdcoin technical paper</a> for
...
public class Block extends Message {
    ...
    static final long ALLOWED_TIME_DRIFT = 2 * 60 * 60; // Same value as Tdcoin Core.

    /**
     * A constant shared by the entire network: how large in bytes a block is allowed to be. One day we may have to
     * upgrade everyone to change this, so Tdcoin can continue to grow. For now it exists as an anti-DoS measure to
    ...
    /**
     * Constructs a block object from the Tdcoin wire format.
     * @deprecated Use {@link TdcoinSerializer#makeBlock(byte[])} instead.
     */
    @Deprecated
    ...
    /**
     * Construct a block object from the Tdcoin wire format.
    ...
    /**
     * Construct a block object from the Tdcoin wire format. Used in the case of a block
     * contained within another message (i.e. for AuxPoW header).
     *
     * @param params NetworkParameters object.
     * @param payloadBytes Tdcoin protocol formatted byte array containing message content.
     * @param offset The location of the first payload byte within the array.
    ...
    /**
     * <p>A utility method that calculates how much new Tdcoin would be created by the block at the given height.
     * The inflation of Tdcoin is predictable and drops roughly every 4 years (210,000 blocks). At the dawn of
     ...
     * Useful for non-Tdcoin chains where the block header may not be a fixed
     * size.
     */
    ...
    public int getOptimalEncodingMessageSize() {
        ...
        optimalEncodingMessageSize = tdcoinSerialize().length;
        return optimalEncodingMessageSize;
    }
    ...
    public Block cloneAsHeader() {
        ...
        copyTdcoinHeaderTo(block);
        return block;
    }

    /** Copy the block without transactions into the provided empty block. */
    protected final void copyTdcoinHeaderTo(final Block block) {
        block.nonce = nonce;
    ...
    /** Returns the version of the block data structure as defined by the Tdcoin protocol. */
     ...
     * the difficulty value reported by the Tdcoin "getdifficulty" RPC that you may see on various block explorers.
    ...
    void addCoinbaseTransaction(byte[] pubKeyTo, Coin value, final int height) {
        ...
        coinbase.length = coinbase.unsafeTdcoinSerialize().length;
    ...
    /**
     * Create a block sending 50TDC as a coinbase transaction to the public key specified.
     ...
     * <a href="https://github.com/tdcoin/bips/blob/master/bip-0034.mediawiki">BIP34: Height in Coinbase</a>.
     */
    ...
    /**
     * Returns whether this block conforms to
     * <a href="https://github.com/tdcoin/bips/blob/master/bip-0066.mediawiki">BIP66: Strict DER signatures</a>.
     */
    ...
    /**
     * Returns whether this block conforms to
     * <a href="https://github.com/tdcoin/bips/blob/master/bip-0065.mediawiki">BIP65: OP_CHECKLOCKTIMEVERIFY</a>.
     */
