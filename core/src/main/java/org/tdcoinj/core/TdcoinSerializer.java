...
/**
 * <p>Methods to serialize and de-serialize messages to the Tdcoin network format as defined in
 * <a href="https://en.tdcoin.it/wiki/Protocol_specification">the protocol specification</a>.</p>
 *
 ...
 * <li>Message.tdcoinSerializeToStream() needs to be properly subclassed</li>
 * </ul>
 */
public class TdcoinSerializer extends MessageSerializer {
    private static final Logger log = LoggerFactory.getLogger(TdcoinSerializer.class);
    ...
    /**
     * Constructs a TdcoinSerializer with the given behavior.
     *
     * @param params           networkParams used to create Messages instances and determining packetMagic
     * @param parseRetain      retain the backing byte array of a message for fast reserialization.
     */
    public TdcoinSerializer(NetworkParameters params, boolean parseRetain) {
        this.params = params;
    ...
    public void serialize(Message message, OutputStream out) throws IOException {
        ...
        if (name == null) {
            throw new Error("TdcoinSerializer doesn't currently know how to serialize " + message.getClass());
        }
        serialize(name, message.tdcoinSerialize(), out);
    }
    ...
    public Message deserialize(ByteBuffer in) throws ProtocolException, IOException {
        // A Tdcoin protocol message has the following format.
        //
        ...
        //
        // Tdcoin Core ignores garbage before the magic header bytes. We have to do the same because
        // sometimes it sends us stuff that isn't part of any message.
        seekPastMagicBytes(in);
        TdcoinPacketHeader header = new TdcoinPacketHeader(in);
     ...
     */
    @Override
    public TdcoinPacketHeader deserializeHeader(ByteBuffer in) throws ProtocolException, IOException {
        return new TdcoinPacketHeader(in);
    }

    /**
     * Deserialize payload only.  You must provide a header, typically obtained by calling
     * {@link TdcoinSerializer#deserializeHeader}.
     */
    @Override
    public Message deserializePayload(TdcoinPacketHeader header, ByteBuffer in) throws ProtocolException, BufferUnderflowException {
    ...
    public static class TdcoinPacketHeader {
        ...
        public TdcoinPacketHeader(ByteBuffer in) throws ProtocolException, BufferUnderflowException {
