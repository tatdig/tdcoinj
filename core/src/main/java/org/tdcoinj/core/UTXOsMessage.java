 ...
 * supported by Tdcoin Core. An implementation is available in <a href="https://github.com/tdcoinxt/tdcoinxt">Tdcoin XT</a>,
 ...
 *
 * <p>The getutxos/utxos protocol is defined in <a href="https://github.com/tdcoin/bips/blob/master/bip-0065.mediawiki">BIP 65</a>.
...
public class UTXOsMessage extends Message {
    ...
    protected void tdcoinSerializeToStream(OutputStream stream) throws IOException {
        ...
        for (int i = 0; i < outputs.size(); i++) {
            ...
            output.tdcoinSerializeToStream(stream);
        }
    }
