...
import org.tdcoinj.net.discovery.*;
...
import org.tdcoinj.utils.VersionTally;

/**
 * <p>NetworkParameters contains the data needed for working with an instantiation of a Tdcoin chain.</p>
 *
...
public abstract class NetworkParameters {
    ...
    public static final byte[] SATOSHI_KEY =
            Utils.HEX.decode("04fc9702847840aaf195de8442ebecedf5b095cdbb9bc716bda9110971b28a49e0ead8564ff0db22209e0374782c093bb899692d524e9d6a6956e7c5ecbcd68284");

    /** The string returned by getId() for the main, production network where people trade things. */
    public static final String ID_MAINNET = "org.tdcoin.production";
    /** The string returned by getId() for the testnet. */
    public static final String ID_TESTNET = "org.tdcoin.test";
    /** The string returned by getId() for regtest mode. */
    public static final String ID_REGTEST = "org.tdcoin.regtest";
    /** Unit test network. */
    public static final String ID_UNITTESTNET = "org.tdcoinj.unittest";
    ...
    private static Block createGenesis(NetworkParameters n) {
        ...
        try {
            ...
            byte[] bytes = Utils.HEX.decode
                    ("04ffff001d010440342d31322d31392041797261742056205a616b69722c2063726561746f72206f662054415444696720456e67696e6520616e642054616e676b7961206e65742e"); //TDCOIN
            t.addInput(new TransactionInput(n, t, bytes));
            ByteArrayOutputStream scriptPubKeyBytes = new ByteArrayOutputStream();
            Script.writeBytes(scriptPubKeyBytes, Utils.HEX.decode
                    ("04486940951aad21ee9646dd1fc43ec8bf01723cdd95661741034888ffa1f21b837c0a59b9c3b625d66379d35055a389ff3f3d849105ee9da67eb82d13d7cdde67")); //TDCOIN
     ...
     *
     * <p>The first block in every chain is a well known constant shared between all Tdcoin implementations. For a
     ...
     * test and main Tdcoin networks use 2 weeks (1209600 seconds).
     */
    ...
    /** How many blocks pass between difficulty adjustment periods. Tdcoin standardises this to be 2016. */
    ...
    /**
     * Scheme part for URIs, for example "tdcoin".
     */
    public abstract String getUriScheme();

    /**
     * Returns whether this network has a maximum number of coins (finite supply) or
     * not. Always returns true for Tdcoin, but exists to be overridden for other
     * networks.
     */
     ...
     */
    public abstract TdcoinSerializer getSerializer(boolean parseRetain);
    ...
    public static enum ProtocolVersion {
        ...
        private final int tdcoinProtocol;

        ProtocolVersion(final int tdcoinProtocol) {
            this.tdcoinProtocol = tdcoinProtocol;
        }

        public int getTdcoinProtocolVersion() {
            return tdcoinProtocol;
        }
    }
}
