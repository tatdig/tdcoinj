...
public class ScriptBuilder {
    ...
    public static Script createInputScript(@Nullable TransactionSignature signature, ECKey pubKey) {
        ...
        byte[] sigBytes = signature != null ? signature.encodeToTdcoin() : new byte[]{};
    ...
    public static Script createMultiSigInputScript(List<TransactionSignature> signatures) {
        ...
        for (TransactionSignature signature : signatures) {
            sigs.add(signature.encodeToTdcoin());
        }
     ...
     * <a href="https://github.com/tdcoin/bips/blob/master/bip-0016.mediawiki">BIP 16</a> to learn more about this
     * kind of script.
     */
    ...
    public static Script createCLTVPaymentChannelRefund(TransactionSignature signature) {
        ScriptBuilder builder = new ScriptBuilder();
        builder.data(signature.encodeToTdcoin());
    ...
    public static Script createCLTVPaymentChannelInput(TransactionSignature from, TransactionSignature to) {
        return createCLTVPaymentChannelInput(from.encodeToTdcoin(), to.encodeToTdcoin());
    }
