...
import org.tdcoinj.core.TdcoinSerializer;

/**
 * Parameters for Tdcoin-like networks.
 */
public abstract class AbstractTdcoinNetParams extends NetworkParameters {

    /**
     * Scheme part for Tdcoin URIs.
     */
    public static final String TDCOIN_SCHEME = "tdcoin";
    public static final int REWARD_HALVING_INTERVAL = 5039370;

    private static final Logger log = LoggerFactory.getLogger(AbstractTdcoinNetParams.class);

    public AbstractTdcoinNetParams() {
        super();
    }
    ...
    public int getProtocolVersionNum(final ProtocolVersion version) {
        return version.getTdcoinProtocolVersion();
    }

    @Override
    public TdcoinSerializer getSerializer(boolean parseRetain) {
        return new TdcoinSerializer(this, parseRetain);
    }

    @Override
    public String getUriScheme() {
        return TDCOIN_SCHEME;
    }
