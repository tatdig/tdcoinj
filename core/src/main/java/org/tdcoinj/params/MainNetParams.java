...
public class MainNetParams extends AbstractTdcoinNetParams {
    ...
    public MainNetParams() {
        ...
        dumpedPrivateKeyHeader = 107; //TDCOIN
        addressHeader = 65; //TDCOIN
        p2shHeader = 82; //TDCOIN
        segwitAddressHrp = "tc"; //TDCOIN
        port = 9901;
        packetMagic = 0x12a6f558L; //TDCOIN
        ...
        genesisBlock.setTime(1556936295L); //TDCOIN
        genesisBlock.setNonce(160868065); //TDCOIN
        id = ID_MAINNET;
        subsidyDecreaseBlockCount = 5039370;
        spendableCoinbaseDepth = 100;
        String genesisHash = genesisBlock.getHashAsString();
        checkState(genesisHash.equals("0000000018bf6fb29c9649e8a31497576e1ac95afd32c3d051ca2d3b0d789ca1"), genesisHash); //TDCOIN

        // This contains (at a minimum) the blocks which are not BIP30 compliant. BIP30 changed how duplicate
        // transactions are handled. Duplicated transactions could occur in the case where a coinbase had the same
        // extraNonce and the same outputs but appeared at different heights, and greatly complicated re-org handling.
        // Having these here simplifies block connection logic considerably.
        checkpoints.put(5000, Sha256Hash.wrap("0000000000e52317e5c59470db44fcfcd377c8f43767d94d72ccaa9e8d5890a4"));//TDCOIN

        dnsSeeds = new String[] {
                "seeds.nigez.com",	//TDCOIN
                "seeds2.nigez.com",	//TDCOIN
                "seeds3.nigez.com",	//TDCOIN
                "seeds4.nigez.com",	//TDCOIN
                "seeds5.nigez.com",	//TDCOIN
        };
        ...
        httpSeeds = new HttpDiscovery.Details[] {
                ...
                new HttpDiscovery.Details(
                        ...
                        URI.create("http://httpseed.tdcoincore.org/peers")
                )
        };
