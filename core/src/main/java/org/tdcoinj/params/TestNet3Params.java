...
/**
 * Parameters for the testnet, a separate public instance of Tdcoin that has relaxed rules suitable for development
 * and testing of applications and new Tdcoin versions.
 */
...
//        alertSigningKey = Utils.HEX.decode("04302390343f91cc401d56d68b123028bf52e5fca1939df127f63c6467cdf9c8e2c14b61104cf817d0b780da337893ecc4aaff1309e536162dabbdb45200ca2b0a");
        ...
        dnsSeeds = new String[] {
                "testnet-seeds.nigez.com", // TDCOIN
/*
                "seed.ttdc.petertodd.org",               // Peter Todd
                "seed.testnet.tdcoin.sprovoost.nl",     // Sjors Provoost
                "testnet-seed.bluematt.me",              // Matt Corallo
                "tdcoin-testnet.bloqseeds.net",         // Bloq
*/
        };
        addrSeeds = null;
    ...
    public void checkDifficultyTransitions(final StoredBlock storedPrev, final Block nextBlock,
        ...
        if (!isDifficultyTransitionPoint(storedPrev.getHeight()) && nextBlock.getTime().after(testnetDiffDate)) {
            ...
            // There is an integer underflow bug in tdcoin-qt that means mindiff blocks are accepted when time
            // goes backwards.
