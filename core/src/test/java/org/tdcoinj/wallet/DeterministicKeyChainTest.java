...
import org.tdcoinj.wallet.listeners.AbstractKeyChainEventListener;
...
public class DeterministicKeyChainTest {
    ...
    public void derive() throws Exception {
        ...
        final Address address = LegacyAddress.fromBase58(UNITTEST, "mjsicQafxJcHdtAAZYbz4REYm86JbFn5b9");
    ...
    public void watchingChainAccountOne() throws UnreadableWalletException {
        ...
        final String pub58 = watchingKey.serializePubB58(MAINNET);
        assertEquals("xpub68j4QFu8dmWX2Paq2UufqfkGaiRuFHSU8wWyqu499J4ecZ7eLAybsepXrDEiV28wCCi4WWNkQFKVkXz5uNiHFUz7peNbroFzfAtpGnszQ5L", pub58);
        watchingKey = DeterministicKey.deserializeB58(null, pub58, MAINNET);
        watchingKey.setCreationTimeSeconds(100000);
    ...
    public void watchingSegwitChain() throws UnreadableWalletException {
        ...
        assertEquals("zpub6nPb1bF7Go8SuhrLSUuX9mZfUhRjswBYCsbz1Zfg1DRKxteqtUUB647SjfTnTLpwEdYAF71R2o3J6NAeZi3s5SvGcQ8LbVWwpss3DEZ2Fhd", pub58);//TDCOIN
        watchingKey = DeterministicKey.deserializeB58(null, pub58, MAINNET);
        watchingKey.setCreationTimeSeconds(100000);
    ...
    public void masterKeyAccount() throws UnreadableWalletException {
        ...
        final String prv58 = watchingKey.serializePrivB58(params);
        assertEquals("xprv9y9nFodtS25LT1QsFbgQFtPnBLx7KZyK99nzayFCVezLsXSuLUZoLMN7vFnSxVbZpNM4Ha4oXYcRV42qCHHFPuAg95EzoVkcGN3rTTGNH9F", prv58);
        watchingKey = DeterministicKey.deserializeB58(null, prv58, params);
        watchingKey.setCreationTimeSeconds(secs);
