...
public class KeyChainGroupTest {
    ...
    public void addAndActivateHDChain_freshCurrentAddress() {
        ...
        assertEquals("TEKyKQsRJ1Hz1wkBSFHKkeiMovEusVmxJL", group.currentAddress(KeyPurpose.RECEIVE_FUNDS).toString());
        ...
        assertEquals("TV5smRNMC49XYro9Zd94VdD87ajHWnjJb1", group.currentAddress(KeyPurpose.RECEIVE_FUNDS).toString());
        ...
        assertEquals("tc1qmvepclm2ntqs0amavm7jxvyjp0362vxgtk4nnv",
    ...
    public void segwitKeyChainGroup() throws Exception {
        ...
        assertEquals("tc1q6xknadz5ejlhhwvtd7pj5v409er4l0ymhtn5w7",
                group.currentAddress(KeyPurpose.RECEIVE_FUNDS).toString());
        assertEquals("tc1qwzm0vqhrkmsx7yn47r4puxdk59nzdxr50zuajf", group.currentAddress(KeyPurpose.CHANGE).toString());
