...
import org.tdcoinj.core.ECKey.ECDSASignature;
import org.tdcoinj.crypto.EncryptedData;
...
import static org.tdcoinj.core.Utils.reverseBytes;
...
public class ECKeyTest {
    ...
    public void verifyMessage() throws Exception {
        // Test vector generated by Tdcoin-Qt.
        String message = "hello";
        String sigBase64 = "H6CwmHXgH+ZIqvj+kMoTaflXfATJH7Xv/KFsg1eGPNprVxLmaozUhmV5Tqezfw9GUy84NwbAfPJOKRIjNXoMAqs=";
        Address expectedAddress = LegacyAddress.fromBase58(MAINNET, "TEkkgToFtnajaWPBW42EDmbBi7MyEr4ybH");
    ...
    public void testCanonicalSigs() throws Exception {
        // Tests the canonical sigs from Tdcoin Core unit tests
    ...
    public void testNonCanonicalSigs() throws Exception {
        // Tests the noncanonical sigs from Tdcoin Core unit tests
