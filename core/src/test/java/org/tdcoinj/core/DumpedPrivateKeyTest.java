...
public class DumpedPrivateKeyTest {
    ...
    public void checkNetwork() throws Exception {
        DumpedPrivateKey.fromBase58(MAINNET, "GtLb1Yr7N4bVFC7EzMxHmHCprkZCPFfqyjdbbcodCaRNJwuyyqMz");
    }
    ...
    public void roundtripBase58() throws Exception {
        String base58 = "4c3qziwAhE4aQMRhkjTTH3RrYEwaSQtzWtNaTN1AC436hpzQtTS"; // 32-bytes key TDCOIN

        DumpedPrivateKey dumpedPrivateKey = DumpedPrivateKey.fromBase58(null, base58); //TDCOIN
    ...
    public void roundtripBase58_invalidCompressed() {
        String base58 = "GtLb1Yr7N4bVFC7EzMxHmHCprkZCPFfqyjdbbcodCaRNJwuyyqMz"; // 32-bytes key
