...
public class PeerGroupTest extends TestWithPeerGroup {
    ...
    public void noPings() throws Exception {
        ...
        versionMessage.clientVersion = NetworkParameters.ProtocolVersion.BLOOM_FILTER.getTdcoinProtocolVersion();
    ...
    public void downloadPeerSelection() throws Exception {
        ...
        versionMessage2.clientVersion = NetworkParameters.ProtocolVersion.BLOOM_FILTER.getTdcoinProtocolVersion();
        versionMessage2.localServices = VersionMessage.NODE_NETWORK;
        VersionMessage versionMessage3 = new VersionMessage(UNITTEST, 3);
        versionMessage3.clientVersion = NetworkParameters.ProtocolVersion.BLOOM_FILTER.getTdcoinProtocolVersion();
    ...
    public void testBloomOnP2Pubkey() throws Exception {
        ...
        assertTrue(p3.lastReceivedFilter.contains(outpoint.unsafeTdcoinSerialize()));
    }
    ...
    public void preferLocalPeer() throws IOException {
        // Because we are using the same port (9901 or 19901) that is used by Tdcoin Core
        ...
        // Check that if we have a localhost port 9901 or 19901 then it's used instead of the p2p network.
    ...
    public void autoRescanOnKeyExhaustion() throws Exception {
        ...
        BloomFilter filter = new BloomFilter(UNITTEST, p1.lastReceivedFilter.tdcoinSerialize());
