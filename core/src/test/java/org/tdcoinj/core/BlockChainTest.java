...
public class BlockChainTest {
    ...
    public void coinbaseTransactionAvailability() throws Exception {
        ...
        // Create a spend with the coinbase TDC to the address in the second wallet - this should now succeed.
    ...
    public void estimatedBlockTime() throws Exception {
        ...
        Date d = prod.estimateBlockTime(10000);
        // The actual date of block 200,000 was 2012-09-22 10:47:00
        assertEquals(new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSSZ", Locale.US).parse("2019-07-12T23:58:15.000-0700"), d);
    }
