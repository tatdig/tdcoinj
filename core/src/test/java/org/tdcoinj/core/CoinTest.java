...
public class CoinTest {
    ...
    public void testToFriendlyString() {
        assertEquals("1.00 TDC", COIN.toFriendlyString());
        assertEquals("1.23 TDC", valueOf(1, 23).toFriendlyString());
        assertEquals("0.001 TDC", COIN.divide(1000).toFriendlyString());
        assertEquals("-1.23 TDC", valueOf(1, 23).negate().toFriendlyString());
    }

    /**
     * Test the tdcoinValueToPlainString amount formatter
     */
    @Test
