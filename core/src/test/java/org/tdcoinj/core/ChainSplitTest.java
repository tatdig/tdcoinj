...
import org.tdcoinj.testing.FakeTxBuilder;
...
public class ChainSplitTest {
    ...
    public void testForking1() throws Exception {
        ...
        assertEquals(Coin.valueOf(300, 0), wallet.getBalance());
        ...
        assertEquals(Coin.valueOf(600, 0), wallet.getBalance());
    }
    ...
    public void testForking3() throws Exception {
        ...
        assertEquals(valueOf(140, 0), wallet.getBalance());
        Block b2 = b1.createNextBlock(someOtherGuy);
        ...
        assertEquals(valueOf(140, 0), wallet.getBalance(Wallet.BalanceType.ESTIMATED));
        assertEquals(ConfidenceType.PENDING, spend.getConfidence().getConfidenceType());
    }
    ...
    private Block roundtrip(Block b2) throws ProtocolException {
        return UNITTEST.getDefaultSerializer().makeBlock(b2.tdcoinSerialize());
    }
    ...
    public void testDoubleSpendOnFork() throws Exception {
        ...
        assertEquals(valueOf(130, 0), wallet.getBalance());
    }
    ...
    public void txConfidenceLevels() throws Exception {
        ...
        assertEquals(Coin.valueOf(750, 0), wallet.getBalance());
    ...
    public void coinbaseDeath() throws Exception {
        ...
        assertTrue(!wallet.poolContainsTxHash(WalletTransaction.Pool.SPENT, coinbase.getTxId()));
        assertTrue(!wallet.poolContainsTxHash(WalletTransaction.Pool.DEAD, coinbase.getTxId()));
        // However, fodder is still dead. Tdcoin Core doesn't keep killed transactions around in case they become
