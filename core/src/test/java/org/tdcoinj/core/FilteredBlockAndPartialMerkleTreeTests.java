...
public class FilteredBlockAndPartialMerkleTreeTests extends TestWithPeerGroup {
    ...
    private static final TdcoinSerializer SERIALIZER = new TdcoinSerializer(UNITTEST, true);
    ...
    public void deserializeFilteredBlock() throws Exception {
        ...
        assertEquals(block, new FilteredBlock(UNITTEST, block.tdcoinSerialize()));
    }
    ...
    public void serializeDownloadBlockWithWallet() throws Exception {
        ...
        // Note that all serialized forms here are generated by Tdcoin Core/pulled from block explorer
        ...
        assertArrayEquals(HEX.decode("0e1b091ca195e45a9164889b6bc46a09000000efbeadde02"), filter.unsafeTdcoinSerialize());
    ...
    public void parseHugeDeclaredSizePartialMerkleTree() throws Exception{
        ...
        PartialMerkleTree pmt = new PartialMerkleTree(UNITTEST, bits, hashes, 3) {
            public void tdcoinSerializeToStream(OutputStream stream) throws IOException {
        ...
        byte[] serializedPmt = pmt.tdcoinSerialize();
        try {
