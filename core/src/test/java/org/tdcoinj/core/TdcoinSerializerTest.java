...
public class TdcoinSerializerTest {
    ...
    "01 00 00 00 01 00 00 00  00 00 00 00 00 00 00 00" +
          ...
          "00 00 00 00 00 ff ff ff  ff 21 01 1e 00 fe 82 ed" +
          "2e 00 fe 0a 5d 06 00 09  63 67 6d 69 6e 65 72 34" +
          "32 08 02 00 00 00 00 00  00 00 00 ff ff ff ff 01" +
          "00 d6 11 7e 03 00 00 00  19 76 a9 14 e0 28 90 6e" +
          "7c 17 10 a3 e2 b1 d7 5b  58 12 cb a1 3f 76 1e 74" +
          "88 ac 00 00 00 00"); //TDCOIN

    @Test
    public void testAddr() throws Exception {
        MessageSerializer serializer = MAINNET.getDefaultSerializer();
        // the actual data from https://en.tdcoin.it/wiki/Protocol_specification#addr
        ...
        assertEquals(9901, peerAddress.getPort());
    ...
    public void testTdcoinPacketHeaderTooShort() {
        new TdcoinSerializer.TdcoinPacketHeader(ByteBuffer.wrap(new byte[] { 0 }));
    }

    @Test(expected = ProtocolException.class)
    public void testTdcoinPacketHeaderTooLong() {
        ...
        new TdcoinSerializer.TdcoinPacketHeader(ByteBuffer.wrap(wrongMessageLength));
    }
