...
import org.tdcoinj.script.Script.VerifyFlag;
...
import static org.tdcoinj.script.ScriptOpCodes.OP_0;
import static org.tdcoinj.script.ScriptOpCodes.OP_INVALIDOPCODE;
...
public class ScriptTest {
    ...
    public void testP2SHOutputScript() throws Exception {
        Address p2shAddress = LegacyAddress.fromBase58(MAINNET, "a83Ch2h2mAY8jRGLT2v4tLb3oRL2DRqqJo"); //TDCOIN
    ...
    public void createAndUpdateEmptyInputScript() throws Exception {
        ...
        assertThat(inputScript.getChunks().get(0).data, equalTo(dummySig.encodeToTdcoin()));
        ...
        assertThat(inputScript.getChunks().get(0).opcode, equalTo(OP_0));
        assertThat(inputScript.getChunks().get(1).data, equalTo(dummySig.encodeToTdcoin()));
        assertThat(inputScript.getChunks().get(2).data, equalTo(dummySig.encodeToTdcoin()));
        ...
        inputScript = ScriptBuilder.updateScriptWithSignature(inputScript, dummySig.encodeToTdcoin(), 0, 1, 1);
        assertThat(inputScript.getChunks().get(0).opcode, equalTo(OP_0));
        assertThat(inputScript.getChunks().get(1).data, equalTo(dummySig.encodeToTdcoin()));
        assertThat(inputScript.getChunks().get(2).opcode, equalTo(OP_0));
        assertThat(inputScript.getChunks().get(3).data, equalTo(multisigScript.getProgram()));

        inputScript = ScriptBuilder.updateScriptWithSignature(inputScript, dummySig.encodeToTdcoin(), 1, 1, 1);
        assertThat(inputScript.getChunks().get(0).opcode, equalTo(OP_0));
        assertThat(inputScript.getChunks().get(1).data, equalTo(dummySig.encodeToTdcoin()));
        assertThat(inputScript.getChunks().get(2).data, equalTo(dummySig.encodeToTdcoin()));
        assertThat(inputScript.getChunks().get(3).data, equalTo(multisigScript.getProgram()));
        ...
        try {
            ScriptBuilder.updateScriptWithSignature(inputScript, dummySig.encodeToTdcoin(), 1, 1, 1);
    ...
    public void dataDrivenInvalidTransactions() throws Exception {
        ...
        for (JsonNode test : json) {
            ...
            // Tdcoin Core checks this case in CheckTransaction, but we leave it to
