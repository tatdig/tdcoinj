...
import org.tdcoinj.core.MessageSerializer;
...
public class FakeTxBuilder {
    ...
    /**
     * Transaction[0] is a feeder transaction, supplying TDC to Transaction[1]
     */
    public static Transaction[] createFakeTx(NetworkParameters params, Coin value,
                                             Address to, Address from) {
        // Create fake TXes of sufficient realism to exercise the unit tests. This transaction send TDC from the
    ...
    public static DoubleSpends createFakeDoubleSpendTxns(NetworkParameters params, Address to) {
        ...
        try {
            doubleSpends.t1 = params.getDefaultSerializer().makeTransaction(doubleSpends.t1.tdcoinSerialize());
            doubleSpends.t2 = params.getDefaultSerializer().makeTransaction(doubleSpends.t2.tdcoinSerialize());
