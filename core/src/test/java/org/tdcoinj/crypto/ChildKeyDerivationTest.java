...
//            ExtendedHierarchicKey ekpub_1_IN_4bil = HDKeyDerivation.deriveChildKey(ekpub_1_IN, 4294967295L);
    ...
    public void testSerializationMainAndTestNetworks() {
        ...
        assertEquals("xpub661MyMwAqRbcGGfymsbtzyTdFpT3BLuXhXqVJcz1CgcZsE8SDZSWrJFTiEqHdVzntjoadfrWSwMB9EFf67JgiUcFErdhHsXXJnfzmPAWoLn", pub58);
        assertEquals("xprv9s21ZrQH143K3nbWfr4tdqWthncYmtBgLJutWEaPeM5azRoHg28GJVvyrx2bZrUqNNNCWHo6b511koP8EeNfWVi8HLnsdz7b1EzaEEEMM9N", priv58);
        pub58 = key1.serializePubB58(TESTNET);
        priv58 = key1.serializePrivB58(TESTNET);
        assertEquals("tpubD6NzVbkrYhZ4Y4rqE4azCtnzawYhAjQbFARnfB39YbNTcWo9HnHbzjvHxGv59zx2geLVFFNNz3BDqQkGUy9vbv4YJTNzyQBktkGQXSXemHx", pub58);
        assertEquals("tprv8ZgxMBicQKsPebq3LQvPoV8t1v2m1QDgfrq1Nezr8Ka4n2YNfPU1pFJRn8CFaDs9jotyWPQrkRapDevsMricKYyioz1BJLqdvLjzfxHYAs1", priv58);
    }
    ...
    public void reserialization() {
        ...
        // https://en.tdcoin.it/wiki/BIP_0032_TestVectors
        String encoded =
