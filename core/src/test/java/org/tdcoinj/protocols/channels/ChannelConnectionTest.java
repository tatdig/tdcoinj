...
import org.tdcoinj.protocols.channels.PaymentChannelClient.VersionSelector;
...
import org.tdcoin.paymentchannel.Protos;
...
import static org.tdcoinj.protocols.channels.PaymentChannelClient.VersionSelector.*;
import static org.tdcoinj.protocols.channels.PaymentChannelCloseException.CloseReason;
import static org.tdcoinj.testing.FakeTxBuilder.createFakeBlock;
import static org.tdcoin.paymentchannel.Protos.TwoWayChannelMessage.MessageType;
...
public class ChannelConnectionTest extends TestWithWallet {
    ...
    private static Wallet roundTripClientWallet(Wallet wallet) throws Exception {
        ...
        org.tdcoinj.wallet.Protos.Wallet proto = WalletProtobufSerializer.parseToProto(new ByteArrayInputStream(bos.toByteArray()));
