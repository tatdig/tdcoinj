...
import wallettemplate.controls.ClickableTdcoinAddress;
import wallettemplate.controls.NotificationBarPane;
import wallettemplate.utils.TdcoinUIModel;
import wallettemplate.utils.easing.EasingMode;
import wallettemplate.utils.easing.ElasticInterpolator;

import static wallettemplate.Main.tdcoin;
...
public class MainController {
    ...
    public ClickableTdcoinAddress addressControl;

    private TdcoinUIModel model = new TdcoinUIModel();
    private NotificationBarPane.Item syncItem;
    private static final MonetaryFormat MONETARY_FORMAT = MonetaryFormat.TDC.noCode();
    ...
    private void showTdcoinSyncMessage() {
        syncItem = Main.instance.notificationBar.pushItem("Synchronising with the Tdcoin network", model.syncProgressProperty());
    }
