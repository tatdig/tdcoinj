...
/**
 * A class that exposes relevant tdcoin stuff as JavaFX bindable properties.
 */
public class TdcoinUIModel {
    ...
    public TdcoinUIModel() {
    }

    public TdcoinUIModel(Wallet wallet) {
        setWallet(wallet);
    }
