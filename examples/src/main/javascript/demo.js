...
// This file shows how to use tdcoinj from Javascript.
// To run, grab the tdcoinj bundled JAR and then do something like this:
//
//   jjs -cp tdcoinj-0.12-bundled.jar demo.js
//
...
//
//   jjs -cp tdcoinj-0.12-bundled.jar
//
...
//
//   jjs -cp tdcoinj-0.12-bundled.jar:$slf4fj demo.js
//
...
// Nashorn, unlike V8, is thread safe (because it runs on the JVM). And tdcoinj is a threaded library. This means you
