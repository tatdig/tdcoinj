...
# Change this to point to where you have a copy of the tdcoinj.jar
sys.path.append(r"/path/to/tdcoinj-core-0.12-bundled.jar")
...
if __name__ == "__main__":
    params = org.tdcoinj.params.TestNet3Params.get()
