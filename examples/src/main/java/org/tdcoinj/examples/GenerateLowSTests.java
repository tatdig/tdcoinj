...
import static org.tdcoinj.script.ScriptOpCodes.getOpCodeName;
import org.tdcoinj.signers.LocalTransactionSigner;
import org.tdcoinj.signers.TransactionSigner.ProposedTransaction;
...
public class GenerateLowSTests {
    ...
    public static void main(final String[] argv)
        ...
        final TransactionSignature signature = TransactionSignature.decodeFromTdcoin(scriptSig.getChunks().get(0).data, true, false);
        ...
        System.out.println("[[[\""
            ...
            + "\"" + Utils.HEX.encode(proposedTransaction.partialTx.unsafeTdcoinSerialize()) + "\", \""
        ...
        input.setScriptSig(new ScriptBuilder().data(highSig.encodeToTdcoin()).data(scriptSig.getChunks().get(1).data).build());
        input.getScriptSig().correctlySpends(outputTransaction, 0, output.getScriptPubKey(),
